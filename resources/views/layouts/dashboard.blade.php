...
<body class="font-poppins antialiased">
    <div x-data="{ sidebarIsOpen: false }" class="relative flex w-full flex-col md:flex-row">
        ...
        <nav x-cloak
            ...
            <!-- logo  -->
            <a href="#" class="ml-2 w-fit text-2xl font-bold text-gray-950 dark:text-gray-100">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 376 155" fill="none" class="w-24"
                    ...
                    <path
                        ...
                        class="fill-gray-950 dark:fill-gray-100"></path>
                    <path
                        ...
                        class="fill-sky-900 dark:fill-sky-400"></path>
                    <g>
                        <path
            ...
            <div class="flex flex-col gap-2 overflow-y-auto pb-6">
                ...
                <a href="/"
                    class="flex items-center rounded-lg gap-2 px-2 py-1.5 text-sm font-medium text-gray-800 underline-offset-2 hover:bg-sky-900/5 hover:text-gray-950 focus-visible:underline focus:outline-none dark:text-gray-300 dark:hover:bg-sky-400/5 dark:hover:text-gray-100">
                ...
                <a href="#"
                    class="flex items-center rounded-lg gap-2 bg-sky-900/10 px-2 py-1.5 text-sm font-medium text-gray-950 underline-offset-2 focus-visible:underline focus:outline-none dark:bg-sky-400/10 dark:text-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg viewBox="0 0 20 20" fill="currentColor"
                        class="size-5 shrink-0" aria-hidden="true">
                        <path
            ...
            <nav class="sticky top-0 z-10 flex items-center justify-between border-b border-gray-500 bg-gray-200 px-4 py-2 dark:border-gray-500 dark:bg-gray-800"
                ...
                <nav class="hidden md:inline-block text-sm font-medium text-gray-800 dark:text-gray-300"
                    ...
                    <ol class="flex flex-wrap items-center gap-1">
                        ...
                        <li class="flex items-center gap-1 font-bold text-gray-950 dark:text-gray-100"
                ...
                <div x-data="{ userDropdownIsOpen: false }" class="relative" x-on:keydown.esc.window="userDropdownIsOpen = false">
                    <button type="button"
                        ...
                        x-bind:class="userDropdownIsOpen ? 'bg-sky-900/10 dark:bg-sky-400/10' : ''"
                        ...
                        <div class="hidden md:flex flex-col">
                            <span
                                class="text-sm font-bold text-gray-950 dark:text-gray-100">{{ auth()->user()->name }}</span>
